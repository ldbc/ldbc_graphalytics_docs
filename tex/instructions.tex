...
\paragraph{Granula} Granula~\cite{DBLP:conf/grades/NgaiHHI17} is a fine-grained performance analysis system consists of four main modules: the modeler, the monitor, the archiver, and the visualizer. 
